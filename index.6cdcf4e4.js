 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $e;$e="",Ae(new X("platform-logger",(e=>new ke(e)),"PRIVATE")),Ae(new X("heartbeat",(e=>new We(e)),"PRIVATE")),Ue("@firebase/app","0.7.26",$e),Ue("@firebase/app","0.7.26","esm2017"),Ue("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */kr="Browser",Ae(new X("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:s}=n.options;return((e,n)=>{rt(i&&!i.includes(":"),"invalid-api-key",{appName:e.name}),rt(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});const r={apiKey:i,authDomain:s,clientPlatform:kr,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Yt(kr)},o=new Qt(e,n,r);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(at);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(o,t),o})(n,r)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Ae(new X("auth-internal",(e=>{const t=Xt(e.getProvider("auth").getImmediate());return new Sr(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Ue("@firebase/auth","0.20.3",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(kr)),Ue("@firebase/auth","0.20.3","esm2017");var Rr=s("4TNnu");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class ys extends Vi{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),i=n.compareTo(r);return 0===i?Kr(e.name,t.name):i}makePost(e,t){const n=_s(e),r=gs.EMPTY_NODE.updateChild(this.indexPath_,n);return new Hi(t,r)}maxPost(){const e=gs.EMPTY_NODE.updateChild(this.indexPath_,ms);return new Hi("[MAX_NAME]",e)}toString(){return Oi(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,u(!Di(e)&&".priority"!==Si(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ws{operationForChild(e){return Di(this.path)?new Ws(this.source,ki(),this.snap.getImmediateChild(e)):new Ws(this.source,Ni(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Fs.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{operationForChild(e){if(Di(this.path)){const t=this.children.subtree(new Ti(e));return t.isEmpty()?null:t.value?new Ws(this.source,ki(),t.value):new zs(this.source,ki(),t)}return u(Si(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new zs(this.source,Ni(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Fs.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xs;class Zs{static fromObject(e){let t=new Zs(null);return Zr(e,((e,n)=>{t=t.set(new Ti(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:ki(),value:this.value};if(Di(e))return null;{const n=Si(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(Ni(e),t);if(null!=i){return{path:xi(new Ti(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Di(e))return this;{const t=Si(e),n=this.children.get(t);return null!==n?n.subtree(Ni(e)):new Zs(null)}}set(e,t){if(Di(e))return new Zs(t,this.children);{const n=Si(e),r=(this.children.get(n)||new Zs(null)).set(Ni(e),t),i=this.children.insert(n,r);return new Zs(this.value,i)}}remove(e){if(Di(e))return this.children.isEmpty()?new Zs(null):new Zs(null,this.children);{const t=Si(e),n=this.children.get(t);if(n){const r=n.remove(Ni(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new Zs(null):new Zs(this.value,i)}return this}}get(e){if(Di(e))return this.value;{const t=Si(e),n=this.children.get(t);return n?n.get(Ni(e)):null}}setTree(e,t){if(Di(e))return t;{const n=Si(e),r=(this.children.get(n)||new Zs(null)).setTree(Ni(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new Zs(this.value,i)}}fold(e){return this.fold_(ki(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(xi(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,ki(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if(Di(e))return null;{const r=Si(e),i=this.children.get(r);return i?i.findOnPath_(Ni(e),xi(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,ki(),t)}foreachOnPath_(e,t,n){if(Di(e))return this;{this.value&&n(t,this.value);const r=Si(e),i=this.children.get(r);return i?i.foreachOnPath_(Ni(e),xi(t,r),n):new Zs(null)}}foreach(e){this.foreach_(ki(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(xi(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(Xs||(Xs=new Qi(Yr)),Xs))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function No(e,t,n,r,i){const s=new ko;let o,a;if(n.type===Fs.OVERWRITE){const c=n;c.source.fromUser?o=Ao(e,t,c.path,c.snap,r,i,s):(u(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Di(c.path),o=Oo(e,t,c.path,c.snap,r,i,a,s))}else if(n.type===Fs.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,c)=>{const l=xi(n,r);xo(t,Si(l))&&(a=Ao(e,a,l,c,i,s,o))})),r.foreach(((r,c)=>{const l=xi(n,r);xo(t,Si(l))||(a=Ao(e,a,l,c,i,s,o))})),a}(e,t,c.path,c.children,r,i,s):(u(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Lo(e,t,c.path,c.children,r,i,a,s))}else if(n.type===Fs.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=bo(r,n))return t;{const a=new Ro(r,t,i),c=t.eventCache.getNode();let l;if(Di(n)||".priority"===Si(n)){let n;if(t.serverCache.isFullyInitialized())n=yo(r,Qs(t));else{const e=t.serverCache.getNode();u(e instanceof gs,"serverChildren would be complete if leaf node"),n=vo(r,e)}l=e.filter.updateFullNode(c,n,s)}else{const i=Si(n);let h=Eo(r,i,t.serverCache);null==h&&t.serverCache.isCompleteForChild(i)&&(h=c.getImmediateChild(i)),l=null!=h?e.filter.updateChild(c,i,h,Ni(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(c,i,gs.EMPTY_NODE,Ni(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=yo(r,Qs(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=bo(r,ki()),Ks(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e=Me()){const t=xe(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=xe(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(B(n.getOptions(),null!=t?t:{}))return e;Ze(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Tr,persistence:[qn,Sn,Nn]})}(),Ic=wc();let Ec=null;const Cc=document.querySelector(".fb-register-form"),Tc=document.querySelector(".reg-button"),kc=document.querySelector(".sign-button"),Sc=document.querySelector(".exit"),Rc=document.querySelector(".fb-message-form"),Nc=document.querySelector(".fb-getdata-form");var Pc,Oc,Ac;kc.addEventListener("click",(function(e){t=Cc.elements.email.value,n=Cc.elements.password.value,function(e,t,n){return Cn(Q(e),ln.credential(t,n))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(bc,t,n).then((e=>{const t=e.user;Ec=t.uid})).catch((e=>{e.code,e.message})),Cc.reset();var t,n})),Tc.addEventListener("click",(function(e){t=Cc.elements.email.value,n=Cc.elements.password.value,Cc.elements.name.value,async function(e,t,n){const r=Xt(e),i=await mn(r,{returnSecureToken:!0,email:t,password:n}),s=await _n._fromIdTokenResponse(r,"signIn",i);return await r._updateCurrentUser(s.user),s}(bc,t,n).then((e=>{const t=e.user;var n;Ec=t.uid,n=Ec,fc(uc(wc(),"users/"+n),{watched:[1,2,3],queue:[1,2,3]})})).catch((e=>{e.code,e.message})),Cc.reset();var t,n})),Sc.addEventListener("click",(function(){(e=bc,Q(e).signOut()).then((()=>{console.log("signoff"),Ec=null})).catch((e=>{}));var e})),Rc.addEventListener("submit",(function(e){e.preventDefault();e.target.elements.message.value;pc(uc(Ic,"users/"+Ec+"/watched"),{id1:null}),e.target.reset()})),Nc.addEventListener("submit",(function(e){e.preventDefault(),gc(uc(Ic,"users/"+Ec+"/watched")).then((e=>{e.exists()?console.log(e.val()):console.log("No data available")})).catch((e=>{console.error(e)}))})),Pc=e=>{e?(Ec=e.uid,Sc.classList.remove("d-none"),Tc.classList.add("d-none")):(Ec=null,Sc.classList.add("d-none"),Tc.classList.remove("d-none"))},Q(bc).onAuthStateChanged(Pc,Oc,Ac);const xc={form:document.querySelector(".search-form"),movieContainer:document.querySelector(".films__gallery")};var Dc;n(Dc=s("bRlFp")).defaults.baseURL="https://api.themoviedb.org/3/";n(Dc).defaults.params={api_key:"5a76e3dab3643dd50fee1a5fab49be2c"};const Lc={_query:"",_page:1,total_pages:null,async getMovieTrend(){const e=await n(Dc).get("/trending/movie/week"),{genres:t}=await this.getGenres();let{results:r,total_pages:i}=e.data;return r=r.map((e=>({...e,genre_ids:e.genre_ids.map((e=>t.find((t=>t.id===e)).name))}))),{results:r,total_pages:i}},async getGenres(){const{data:e}=await n(Dc).get("genre/movie/list");return e},get page(){return this._page},async getSearchMovieResult(){console.log(this._query);const e=await n(Dc).get(`search/movie?language=en-US-RU-UA&query=${this._query}&page=${this._page}`),{genres:t}=await this.getGenres();let{results:r,total_pages:i}=e.data;return r=r.map((e=>({...e,genre_ids:e.genre_ids.map((e=>t.find((t=>t.id===e)).name))}))),{results:r,total_pages:i}}},{MovieTrendContainer:Mc}=xc;function Uc(e){Bc(e)}function Fc(e){Bc(e)}function Bc(e){xc.movieContainer.innerHTML="";const t=e.map((({title:e,vote_average:t,release_date:n,genre_ids:r,poster_path:i})=>`\n<li class="gallery-items films__gallery-item">\n<a href="#!" class="list-card__link">\n\x3c!-- постер --\x3e\n<div class="moviе-item__img-container">\n <img\n         src="https://www.themoviedb.org/t/p/w600_and_h900_bestv2/${i}"\n        alt="${e}"\n         class="moviе-item__img"\n   />\n     </div>\n\x3c!-- обгортка інформації під постером --\x3e\n<div class="moviе-stats">\n    <h2 class="moviе-stats__title">${e}</h2>\n    <div class="moviе-stats__info">\n\x3c!-- список жанрів --\x3e\n<p class="moviе-genre">${r}</p>\n\x3c!-- дата виходу та рейтинг --\x3e\n<p class="moviе-year">${new Date(n).getFullYear()}</p>\n\x3c!-- рейтинг --\x3e\n<p class="moviе-vote">${t}</p>\n</div>\n    </div>\n</a>\n</li>`)).join("");xc.movieContainer.insertAdjacentHTML("beforeend",t)}document.addEventListener("DOMContentLoaded",(async()=>{try{xc.movieContainer.innerHTML="";const{results:e}=await Lc.getMovieTrend();Uc(e)}catch(e){console.error(e.message)}}));xc.form.addEventListener("submit",(async e=>{if(e.preventDefault(),Lc._query=e.target.elements.query.value.trim(),Lc._query)try{xc.movieContainer.innerHTML="";const{results:e}=await Lc.getSearchMovieResult();Fc(e),xc.form.reset()}catch(e){console.error(e.message)}}));
//# sourceMappingURL=index.6cdcf4e4.js.map
